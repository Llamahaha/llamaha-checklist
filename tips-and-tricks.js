import { tipsAndTricksSections } from "./supportData.js";
...
function renderSections() {
  ...
  tipsAndTricksSections.forEach(section => {
    ...
    kicker.textContent = "Tips & Tricks";
  ...
  renderPageToc(pageToc, tocItems, {
    ...
    description: "Use these quick links to move between the Tips & Tricks sections on this page."
  });
}
