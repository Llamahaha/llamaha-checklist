...
export function buildSearchIndex() {
  ...
  const entries = [
    ...
    entry("App Help", "Browse popular applications, Microsoft 365 apps, remote-access tools, engineering apps, and the full application directory when you already know the product name.", "applications.html", "helpPage", "Support Pages", "app help application directory outlook teams onedrive sharepoint citrix forticlient autocad revit civil 3d arcgis projectwise oracle p6 indesign google earth hec h20net hydraulic toolbox hy8 hy-8 hcs hss"),
    entry("Popular Applications", "Open the most-used application guides directly from the Support Pages app guide topic list.", "applications.html#microsoft-outlook", "helpPage", "Support Pages", "popular applications outlook teams onedrive sharepoint citrix forticlient adobe acrobat bluebeam autocad revit civil 3d arcgis projectwise oracle p6"),
    entry("Collaboration, File Access, and Remote Work", "Search Microsoft 365, Citrix Workspace, VPN, and file-access app guide topics when you need collaboration or remote-work help.", "applications.html#microsoft-teams", "helpPage", "Support Pages", "outlook teams onedrive sharepoint authenticator citrix forticlient egnyte remote work"),
    entry("Design, Engineering, Mapping, and Projects", "Search Autodesk, Bentley, ArcGIS, Primavera, Google Earth Pro, HEC, FHWA Hydraulics, MCTRANS, and related project app guide topics.", "applications.html#autodesk-revit", "helpPage", "Support Pages", "autocad revit civil 3d infoworks icm microstation projectwise arcgis pro google earth hec hms hec ras fhwa hydraulics h20net hydraulic toolbox hy8 hy-8 hcs hss primavera p6"),
    entry("Full Application Directory", "Browse every supported public application from the Support Pages app guide topic list.", "applications.html", "helpPage", "Support Pages", "application directory vendors products guides"),
    ...
    entry("Submit a Ticket", "Open the ticket form to send the app, page, account, exact issue, screenshot details, browser check, other-device check, and item details needed for review.", "ticket.html", "helpPage", "Ticket Form", "ticket contact support request form help account app version screenshot browser device file project site path"),
    ...
    entry("AutoElevate Install Approvals", "AutoElevate is the approval bridge that lets IT clear a single install or admin action on a managed work computer without making you an administrator. Explains why we use it, how to respond to the prompt, what each outcome means, and the security rules to follow.", "auto-elevate.html", "helpPage", "Help Page", "autoelevate auto elevate elevation install approval admin uac user account control prompt installer update driver request reason ticket security managed computer standard user"),
    ...
    entry("Browser Support", "Open support articles when work sites, downloads, or sign-in pages behave differently in Chrome, Edge, Firefox, or Safari.", "computer-issues.html#a-work-site-works-in-one-browser-but-not-another", "helpPage", "Support Pages", "browser support chrome edge firefox safari sign in downloads cookies cache")
  ];
