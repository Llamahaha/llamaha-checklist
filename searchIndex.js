...
export function buildSearchIndex() {
  ...
  const entries = [
    ...
    entry("Design, Engineering, Mapping, and Projects", "Search Autodesk, Bentley, ArcGIS, Primavera, Google Earth Pro, HEC, H20Net, MCTRANS, and related project app guide topics.", "applications.html#autodesk-revit", "helpPage", "Support Pages", "autocad revit civil 3d infoworks icm microstation projectwise arcgis pro google earth hec hms hec ras h20net hydraulic toolbox hy8 hy-8 hcs hss primavera p6"),
